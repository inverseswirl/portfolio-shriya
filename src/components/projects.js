    ...
    <div className="projects">
      ...
      >
        <path
          fill="#ffffff"
          fillOpacity="1"
          d="M0,256L80,250.7C160,245,320,235,480,213.3C640,192,800,160,960,160C1120,160,1280,192,1360,208L1440,224L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"
        ></path>
      </svg>
      ...
      <div className="projects-project1">
        ...
        <a
          href="https://emi-cal.netlify.app/"
          rel="noreferrer"
          target="_blank"
          className="projects-project1-name"
        >
          EMI Calculator
        </a>
      </div>
      ...
      <div className="projects-project2">
        ...
        <a
          href="https://accent-s26.netlify.app"
          rel="noreferrer"
          target="_blank"
          className="projects-project2-name"
        >
          Accent App
        </a>
      </div>
      <div className="projects-project3">
        ...
        <a
          href="https://weatherapp-s26.netlify.app"
          rel="noreferrer"
          target="_blank"
          className="projects-project3-name"
        >
          Weather App
        </a>
      </div>
      ...
      <div className="projects-copy">
        <AiOutlineCopyrightCircle size={17} style={{ marginBottom: "-4px" }} />{" "}
        Shriya 2021
      </div>
    </div>
  );
